const DOC_BASE = "https://foodlay-doc.dayonesoft.com";
const ADMIN_URL = "https://foodlay.dayonesoft.com/admin/auth/login";
const WEB_URL = "https://foodlay.dayonesoft.com";
...
async function bootstrap() {
  ...
  document.getElementById("admin-open").href = ADMIN_URL;
  document.getElementById("admin-docs").href = DOC_BASE;
  document.getElementById("store-open").href = WEB_URL;
  document.getElementById("store-docs").href = DOC_BASE;
  document.getElementById("customer-open").href = state.links.customerApk;
  document.getElementById("customer-docs").href = DOC_BASE;
  document.getElementById("delivery-open").href = state.links.deliveryApk;
  document.getElementById("delivery-docs").href = DOC_BASE;
